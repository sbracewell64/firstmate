...
A silent bootstrap section needs no action; for any printed actionable diagnostic line, including `ADMISSION_CONTROL:`, load `bootstrap-diagnostics` and follow its owner procedure.
