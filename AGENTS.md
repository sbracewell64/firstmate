...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  projects.md        thin fleet navigation registry recording each project's standing delivery posture and, on a fork layout, the contribution posture that decides which trunk its tasks are cut from and where their pull requests are raised; firstmate-private, parsed for mechanical sync, seeding, and dispatch by fm-project-mode.sh (section 6)
