...
#
# BASIS (2026-08-26). Measured on this repo's own PR CI run 33012539386, whose
# eight portable-serial artifacts cover this head's complete inventory of 137
# scripts. They sum to 2997408 ms of script time, the declared budget below.
# Job wall exceeded script sum by under 1 s on every shard, so the shard wall is
# the script sum for budgeting purposes.
#
...
PORTABLE_SERIAL_BUDGET_MS=2997408

# How many separate-runner shards the portable serial remainder splits into.
# One owner: CI lane names carry this count and are refused when they disagree.
#
# Derived, not chosen: 8 shards put the balanced wall at 2997408/8 = 374676 ms
# (~6.24 min) against the 15-minute cap below, a 2.4x hang-tripwire margin.
# Four shards would put it at ~12.49 min and 1.2x, which is below the safe
# margin this lane requires.
# The floor for any count is the longest single script
# (tests/fm-pr-check-security.test.sh, 206964 ms), which binds near 10 shards.
...
# the bound is 9 min: 1.44x the ~6.24 min balanced wall, but still low enough to
# fire before a shard reaches the cap.
...
# (2997408/137 = 21879 ms) so a newly added test neither starves nor overloads
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-admission.test.sh 10479
tests/fm-afk-inject-e2e.test.sh 33497
tests/fm-afk-pi-herdr-return-e2e.test.sh 70
tests/fm-afk-return.test.sh 1086
tests/fm-ask-user-authority.test.sh 82
tests/fm-attempt.test.sh 17389
tests/fm-attest.test.sh 62331
tests/fm-attribution-sweep.test.sh 834
tests/fm-backend-cmux-smoke.test.sh 20
tests/fm-backend-cmux.test.sh 2897
tests/fm-backend-herdr-focus-flash-e2e.test.sh 18
tests/fm-backend-orca.test.sh 13224
tests/fm-backend-tmux-smoke.test.sh 435
tests/fm-backend-zellij-smoke.test.sh 17
tests/fm-backend-zellij.test.sh 6663
tests/fm-backend.test.sh 22516
tests/fm-backlog-handoff.test.sh 2678
tests/fm-bearings-snapshot.test.sh 66963
tests/fm-blocker-lib.test.sh 4379
tests/fm-bootstrap.test.sh 64920
tests/fm-busy-adapter-wiring.test.sh 17316
tests/fm-busy-state.test.sh 753
tests/fm-calm-pi-extension.test.sh 263
tests/fm-capability-catalog.test.sh 596
tests/fm-capacity-retry.test.sh 39281
tests/fm-capacity-routing.test.sh 47212
tests/fm-certify.test.sh 6039
tests/fm-classify.test.sh 5689
tests/fm-claude-stop-autoarm-live-e2e.test.sh 17
tests/fm-claude-stop-autoarm.test.sh 60645
tests/fm-codex-continuity-live-e2e.test.sh 19
tests/fm-commitment-register.test.sh 23174
tests/fm-conflict-marker-check.test.sh 214
tests/fm-context-statusline.test.sh 527
tests/fm-daemon.test.sh 31254
tests/fm-dead-predicate-check.test.sh 161539
tests/fm-decision-surface.test.sh 7556
tests/fm-documentation-audiences.test.sh 658
tests/fm-exact-head-green-one-owner.test.sh 2557
tests/fm-execution-replacement.test.sh 103107
tests/fm-fleet-snapshot-view.test.sh 78853
tests/fm-fleet-sync.test.sh 17917
tests/fm-gate-refuse.test.sh 4980
tests/fm-gitignore-config.test.sh 23
tests/fm-gotmp.test.sh 409
tests/fm-grok-continuity-live-e2e.test.sh 15
tests/fm-grok-stop-live-e2e.test.sh 18
tests/fm-guard-stale-banner.test.sh 4962
tests/fm-harness-liveness-drift-live-e2e.test.sh 19
tests/fm-herdr-session-cleanup.test.sh 10360
tests/fm-kimi-harness.test.sh 17063
tests/fm-landed-lib.test.sh 3270
tests/fm-landing-authorization.test.sh 8326
tests/fm-landing-seam.test.sh 14982
tests/fm-launch-lib.test.sh 931
tests/fm-launch.test.sh 6778
tests/fm-loop-actuate.test.sh 9045
tests/fm-loopspec.test.sh 12991
tests/fm-merge-local.test.sh 12079
tests/fm-model-registry.test.sh 812
tests/fm-model-zero-budget.test.sh 3245
tests/fm-nm-run-lib.test.sh 853
tests/fm-on.test.sh 6793
tests/fm-opencode-primary-live-e2e.test.sh 19
tests/fm-operational-input.test.sh 224
tests/fm-outbound-artifact.test.sh 46265
tests/fm-pending-reply.test.sh 7458
tests/fm-pi-primary-live-e2e.test.sh 16
tests/fm-pi-watch-extension.test.sh 16161
tests/fm-pr-check-security.test.sh 206964
tests/fm-procevent.test.sh 49038
tests/fm-public-followup.test.sh 29653
tests/fm-publication-seam.test.sh 42861
tests/fm-qualification.test.sh 7143
tests/fm-quota-array-dispatch-live-e2e.test.sh 13
tests/fm-reasoning-required.test.sh 43952
tests/fm-rebase-equivalence.test.sh 8370
tests/fm-remote-backlog-handoff.test.sh 18463
tests/fm-remote-doctor.test.sh 3612
tests/fm-remote-job.test.sh 38205
tests/fm-remote-reply.test.sh 9487
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 170949
tests/fm-remote-secondmate-trace-context.test.sh 35259
tests/fm-research-scan.test.sh 3307
tests/fm-retrieval-contract.test.sh 12422
tests/fm-review-exec.test.sh 3717
tests/fm-review-mutation.test.sh 40457
tests/fm-route-enforcement.test.sh 23427
tests/fm-route-qualification.test.sh 32724
tests/fm-ruling-reconcile.test.sh 15953
tests/fm-secondmate-harness.test.sh 121283
tests/fm-secondmate-lifecycle-e2e.test.sh 5761
tests/fm-secondmate-liveness.test.sh 11681
tests/fm-secondmate-safety.test.sh 45383
tests/fm-secondmate-sync.test.sh 20449
tests/fm-send-marker.test.sh 4358
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 40
tests/fm-session-lock-ancestry.test.sh 944
tests/fm-session-start.test.sh 50130
tests/fm-sessionstart-nudge.test.sh 342
tests/fm-shared-captain-inheritance.test.sh 4524
tests/fm-slot-reservation.test.sh 32091
tests/fm-spawn-dispatch-profile.test.sh 51872
tests/fm-spawn-worktree-settle.test.sh 14490
tests/fm-startup-memory-budget.test.sh 6544
tests/fm-subagent-pretool-check.test.sh 1136
tests/fm-supervision-events.test.sh 552
tests/fm-tangle-guard.test.sh 11091
tests/fm-task-axis.test.sh 1735
tests/fm-task-base.test.sh 28476
tests/fm-task-delivery.test.sh 10929
tests/fm-teardown-endpoint-safety.test.sh 1333
tests/fm-teardown.test.sh 121092
tests/fm-test-fixture-cleanup.test.sh 493
tests/fm-test-isolation-proof.test.sh 27381
tests/fm-test-lib-wait.test.sh 6450
tests/fm-tmux-agent-liveness.test.sh 701
tests/fm-trace-context-lib.test.sh 242
tests/fm-trace-context-spawn.test.sh 42623
tests/fm-turnend-guard.test.sh 17771
tests/fm-unattended-session.test.sh 6156
tests/fm-update.test.sh 5110
tests/fm-vendor-auth-probe.test.sh 42868
tests/fm-verify-fork-landing.test.sh 135
tests/fm-verify.test.sh 5306
tests/fm-wake-daemon-lifecycle-e2e.test.sh 8881
tests/fm-wake-drain-open-decisions.test.sh 4043
tests/fm-wake-ledger.test.sh 16054
tests/fm-wake-queue.test.sh 24925
tests/fm-watch-arm.test.sh 27213
tests/fm-watch-checkpoint.test.sh 4123
tests/fm-watch-triage.test.sh 202092
tests/fm-watcher-lock.test.sh 100289
tests/fm-worker-initiated-validation.test.sh 173
tests/fm-worktree-guard.test.sh 8060
tests/fm-wrong-subject.test.sh 259
tests/fm-wsl-entry.test.sh 67
EOF
}
