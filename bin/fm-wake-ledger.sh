...
#            escalated, findings, critic_process, critic_vendor, critic_model,
#            pr.
#
...
#       task metadata it is about to delete. --critic-repo with --critic-branch
#       resolves the reviewing configuration from the pipeline's own records;
#       an explicit --critic-* value wins over what that resolves.
