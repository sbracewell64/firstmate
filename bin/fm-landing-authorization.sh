...
observe_head() {  # <owner/repo> <number> -> prints sha, or returns 1
  ...
  # fm-retrieval-audit: conservative-negative - a failed head read returns could-not-observe to the caller,
  # which stops the authorized action and preserves the unspent authorization.
