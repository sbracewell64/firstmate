...
- `stale` for a crew `bin/fm-crew-state.sh` reports as provably working -> self-handle and drop it from wedge aging entirely, recording neither a wedge nor a pause marker.
