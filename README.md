...
| Skill              | What it does                                                                                                                                  |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| `/afk`             | Enter away-mode supervision: the sub-supervisor self-handles routine notifications in bash, escalates captain-relevant events and declared external waits whose recorded blocker moved, could not be observed, or forms a dependency cycle, keeps timer rechecks for waits without a blocker, and actively alerts if delivery gets stuck while you step away |
