...
The first fresh successor descendant whose ordinary pipeline run begins after this policy lands and reconciles onto the settled governed generation removes it - the two-generation rule applied to the workflow file.
