...
The current focused green suites were re-run at exact implementation head `dcec9b8a4a31d67517559104d86c52ca9eb1a4ad` after forge head provenance was preserved across the correlation-record lifecycle.
...
The focused suites were re-run on 2026-08-17 at exact implementation head `dcec9b8a4a31d67517559104d86c52ca9eb1a4ad` with `bash tests/fm-outbound-artifact.test.sh && bash tests/fm-dead-predicate-check.test.sh && bash tests/fm-bootstrap.test.sh`; the command exited 0.
