...
The controls below were exercised at implementation head `ab9126f0898fd2a8dd6dbeca8bcc86eea6315b0e`.
...
Thirteen controls, each observing a real commit object's author and committer or the absence of one, because a verdict about configuration would be a verdict about the wrong subject.
