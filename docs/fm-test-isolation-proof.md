...
- Started from: `FM_ISOLATION_FRESHNESS STALE subjects=24 proven=23 stale=1`, the fixed point the previous procedure could not leave
- Result, one pass, exit 0:

```
FM_ISOLATION_SUMMARY total=24 failed=0 concurrency=4 duration_ms=252681
