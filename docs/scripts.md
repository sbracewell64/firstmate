...
| `fm-project-mode.sh`     | Resolve a project's registered delivery and contribution posture from `data/projects.md` for fleet sync, home seeding, and task dispatch |
