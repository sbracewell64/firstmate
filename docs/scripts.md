...
| `fm-context-statusline.sh` | Render Claude's host-computed context pressure and optional task snapshot with the 70-percent compaction advisory and the route's governed smart-zone ceiling |
