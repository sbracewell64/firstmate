...
# collides with the primary home's own crew-workspace label - with a live
# long-running process in that pane, exactly as
...
# Explicitly label the startup workspace with the primary home's own crew label
